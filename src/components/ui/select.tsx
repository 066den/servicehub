...
function SelectTrigger({
	...
	return (
		<SelectPrimitive.Trigger
			...
			data-size={size}
			className={cn(
				'flex h-12 w-full items-center justify-between gap-2 rounded-lg border-2 border-gray-200 bg-gray-50 px-4 py-3 text-base font-normal text-gray-900 placeholder:text-gray-500 transition-all duration-300 ease',
